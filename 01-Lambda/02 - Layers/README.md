...
1. No terminal do IDE criado no cloud9 execute o comando `cd ~/environment/senai-serverless/01-Lambda/02\ -\ Layers/` para entrar na pasta que fara este exercicio.
